...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#image01', { style: 'slide-left', speed: 1000, intensity: 5, delay: 0, state: true, replay: true });
		onvisible.add('#text09', { style: 'slide-right', speed: 1000, intensity: 5, delay: 0, state: true, replay: true });
		onvisible.add('#text01', { style: 'fade-in', speed: 1375, intensity: 5, delay: 750, state: true, replay: true });
